...
-   **Have common sense, do not be dumb, look and learn from others' mistakes, watch/read these:**
    ...
    - 2024, Github repository of bad opsec: <https://github.com/jermanuts/bad-opsec> <sup>[<sup>[[Archive.org]](https://web.archive.org/web/https://github.com/jermanuts/bad-opsec)</sup>
